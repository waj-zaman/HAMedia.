...
const ServicesSection = () => {
  return (
    <section className="bg-gradient-to-b from-[#F5EBD1] to-[#f8f5ec] flex justify-center py-16 sm:py-20 px-4 sm:px-6">
      <div className="w-full max-w-[1300px] text-gray-900">
        {/* HEADER */}
        <div className="text-center mb-12 sm:mb-16 px-2 sm:px-8">
        ...
        {/* CARDS CONTAINER */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 max-w-6xl mx-auto w-full sm:w-11/12 md:w-4/5">
          
          {/* DIGITAL PRESENCE CARD */}
          <div className="relative bg-white/90 backdrop-blur-md p-6 sm:p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-200 hover:border-amber-500/30 hover:shadow-[0_8px_30px_rgb(255,193,7,0.15)] transform hover:scale-[1.03] md:hover:scale-[1.05] transition-all duration-500 ease-out">
            ...
            {/* LIST */}
            <ul className="heading space-y-3 text-gray-700 text-sm sm:text-md">
              {[
