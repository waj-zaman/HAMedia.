...
const Portfolio = () => {
  ...
  return (
    <section
      id="portfolio"
      className="bg-[#6B5F52] py-16 md:py-20 px-4 md:px-6 text-center overflow-hidden"
    >
      {/* Section Heading */}
      <motion.div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 max-w-6xl mx-auto">
        ...
        {/* ✅ Card 1 (Zuza Farm House) — now slides in from LEFT */}
        <motion.div
        ...
        {/* ✅ Card 2 (SZR Farms) — now slides in from RIGHT */}
        <motion.div
          className="group relative bg-[#F8F6F3] rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300"
          initial={{ opacity: 0, x: 80 }}
          whileInView={{ opacity: 1, x: 0 }}
      ...
      >
        <button
          ...
          className="heading bg-[#FF4C1E] hover:bg-[#e04318] text-white font-semibold py-2.5 md:py-3 px-6 md:px-8 rounded-lg flex items-center justify-center gap-2 mx-auto transform hover:scale-110 transition-all duration-300 shadow-md hover:shadow-xl"
        >
