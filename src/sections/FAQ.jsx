...
const FAQ = () => {
  ...
  return (
    <section className="bg-[#FBF4E3] py-16 md:py-24 px-4 md:px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-3">
          {faqs.map((question, index) => (
            <div
              key={index}
              className="bg-white shadow-md border border-gray-100 rounded-md py-3 px-4 text-left text-gray-800 text-sm hover:shadow-xl hover:scale-[1.03] transition-transform duration-200"
            >
